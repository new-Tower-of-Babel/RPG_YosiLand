...
public class InputNumber : MonoBehaviour
{
    ...
    IEnumerator DropItemCoroutine(int _num)
    {
        for (int i = 0; i < _num; i++)
        {
            ...
            {
                Instantiate(DragSlot.instance.dragSlot.item.itemPrefab, thePlayer.transform.position+new Vector3(0f,3f,0f), Quaternion.identity);
                Debug.Log(DragSlot.instance.dragSlot.item.itemPrefab);
            }
